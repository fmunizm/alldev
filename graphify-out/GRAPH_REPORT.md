# Graph Report - alldev  (2026-05-16)
...
## Summary
- 150 nodes · 128 edges · 29 communities (27 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6d20346`
...
Cohesion: 0.12
Nodes (15): 11. REFERENCIAS RAPIDAS, 1 Ative o GitHub Pages, 2 Crie o GPT em [chat.openai.com/gpts/editor](https://chat.openai.com/gpts/editor), 7. ESTRUTURA DO REPO, 9. APRENDIZADO E ATUALIZACAO CONTINUA, AllDev GPT  Dev Fullstack + DevOps + QA Autnomo, Arquivos da raiz (amostra), code:block1 (.claude) (+7 more)
...
## Knowledge Gaps
- **83 isolated node(s):** `routes`, `components`, `tests`, `database`, `routes` (+78 more)
