# Prompts e Templates - fmunizm/alldev
...
```
Trabalhando em fmunizm/alldev. Como Engenheiro DevOps + Toolkit Multi-Stack.
...
```
Feature nova em fmunizm/alldev: <DESCRICAO>
...
```
Bug em fmunizm/alldev: <DESCRICAO + STACK TRACE / SCREENSHOT>
...
```
Auditoria em fmunizm/alldev: <ESCOPO>
...
```
Deploy em fmunizm/alldev: versao <X.Y.Z>
...
```
Descobri novo padrao em fmunizm/alldev que vale virar skill.
